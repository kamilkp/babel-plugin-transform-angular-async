...
var _default = {
  ...
  AwaitExpression(path) {
    ...
    const digestExpression = () => _core.types.logicalExpression('&&', _core.types.unaryExpression('!', _core.types.memberExpression(_core.types.identifier('$rootScope'), _core.types.identifier('$$phase'))), _core.types.callExpression(_core.types.memberExpression(_core.types.identifier('$rootScope'), _core.types.identifier('$digest')), []));
